...
class _MechHomePageState extends State<MechHomePage> {
  ...
  //      ********* ************** ************  1ST FUNCTION WORKS FINE FOR TESTING PURPOSE     ********* ************** ************
  ...
  //             Column(
  //               crossAxisAlignment: CrossAxisAlignment.start,
  //               children: orderDetails['selectedProblems']
  ...
  //             Column(
  //               crossAxisAlignment: CrossAxisAlignment.start,
  //               children: orderDetails['selectedThings']
  //                   .map<Widget>((thing) => Text(thing.toString()))
  //                   .toList(),
  //             ),
  //             SizedBox(height: 10),
  //             Text('Timestamp: ${orderDetails['timestamp'].toDate().toString()}'),
  //           ],
  //         ),
  //         actions: <Widget>[
  //           TextButton(
