                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          {     // At least one problem is selected, navigate to the map page
                                Navigator.push(  context,   MaterialPageRoute(builder: (context) => MapPage()), );
                          }
                          else {  // No problem selected, show a Snackbar
                                  ScaffoldMessenger.of(context).showSnackBar( SnackBar( content: Text("You haven't selected any problem"),  ),  );
                               }
                        },
                        style: ElevatedButton.styleFrom(
                          primary: Colors.green,
