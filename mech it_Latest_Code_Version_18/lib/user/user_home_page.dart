        ...
        child: ListView(
          ...
          children: [
            UserAccountsDrawerHeader(
              accountName: Text(userData['Name'] ?? 'User_Name'), // Name displayed dynamically
              accountEmail: Text(userData['Email'] ?? 'User_Name@gmail.com'), // Email displayed dynamically
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  // colors: [Colors.blue, Colors.green],                             // for second last option
                  colors: [Colors.blue, Colors.deepPurple],             // superb matching with theme
                  // colors: [Colors.green, Colors.deepPurple],                       // for last option
                  // colors: [Colors.deepPurple, Colors.blue],             // ok matching with theme
                  // colors: [Colors.deepPurple, Colors.green],                     // for last option
                  // colors: [Colors.deepPurple, Colors.deepPurpleAccent],    // good matching with theme
