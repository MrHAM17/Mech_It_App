                      ...
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(
                            selectedButtonIndex == 0 ? Colors.indigo : Colors.grey, // Change button color based on selection
                          ),
                        ),
                      ),
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(
                            selectedButtonIndex == 1 ? Colors.indigo : Colors.grey, // Change button color based on selection
                          ),
                        ),
                      ),
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(
                            selectedButtonIndex == 2 ? Colors.indigo : Colors.grey, // Change button color based on selection
                          ),
                        ),
                      ),
                    ],
...
class _InteriorScreenState extends State<InteriorScreen> {
  ...
  String expectedRent_OnePointOne = "Expected rent ₹ 850"; // Expected rent 1
  String subProblemName_OnePointTwo = "Change the break sensor"; // Subproblem name 2
  String expectedRent_OnePointTwo = "Expected rent ₹ 750"; // Expected rent 2
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Alexogen sensor change                          (Expected rent ₹ 850)",
                              style: TextStyle(
                                fontSize: 16,
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Change the break sensor                          (Expected rent ₹ 750)",
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black, // Checkbox text color
                              ),
...
class _ExteriorScreenState extends State<ExteriorScreen> {
  ...
  String expectedRent_TwoPointOne = "(Expected rent ₹ 350)"; // Expected rent 1
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Size 16 BOSCH change pad                          (Expected rent ₹ 350)",
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black, // Checkbox text color
                              ),
...
class _ChassisScreenState extends State<ChassisScreen> {
  ...
  String expectedRent_ThreePointOne = "(Expected rent ₹ 500)"; // Expected rent 2
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Average sized 1 coach                                   (Expected rent ₹ 500)",
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black, // Checkbox text color
                              ),
