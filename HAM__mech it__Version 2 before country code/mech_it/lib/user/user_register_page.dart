...
class _UserRegisterPageState extends State<UserRegisterPage> {
  ...
  Widget _buildPhoneNumberInput() {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start, // Align both inputs to the top
      children: [
        // Country Code Input
        Container(
          width: 96,
          height: 48, // Set the height to match the Phone Number Input
          child: _buildInputField(
            registerusercountryCodeController,
            // labelText: "Country Code",
            prefixIcon: Icon(Icons.add), // Icon for Country Code
          ),
        ),
        const SizedBox(width: 10), // Add some spacing between the two inputs
        // Phone Number Input wrapped in Padding
        Expanded(
          child: Padding(
            padding: const EdgeInsets.only(top: 0), // No top spacing for phone number
            child: Container(
              height: 48, // Set the height to match the Country Code Input
              child: _buildInputField(
